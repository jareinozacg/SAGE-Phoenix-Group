...
class EstacionamientosForm(forms.ModelForm):
    nombre_duenio = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'Nombre del Dueno'}))
    ...
    telefono1 = forms.IntegerField(widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'Telefono 1',}))
    ...
    telefono3 = forms.IntegerField(widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'Telefono 3',}), required=False)
    email1 = forms.EmailField(widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'Correo Electronico 1',}))
    email2 = forms.EmailField(widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'Correo Electronico 2',}), required=False)
    email3 = forms.EmailField(widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'Correo Electronico 3',}), required=False)
...
class PagoForm(forms.ModelForm):
    ...
    cedula = forms.IntegerField(widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'Cedula',}))
    ...
    numeroTarjeta = forms.RegexField(min_length=16, max_length=16, regex=r'^(\d)+$',
        error_message = ("Numero de tarjeta no v�lido."), widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'N�mero de Tarjeta',}))
